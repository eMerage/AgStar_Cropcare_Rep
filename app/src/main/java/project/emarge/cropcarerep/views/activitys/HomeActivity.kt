...
import project.emarge.cropcarerep.views.adaptors.home.PagerHomeAdapter
...
class HomeActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener  {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //val sectionsPagerAdapter = HomePagerAdapter(this, supportFragmentManager,visitID,visitCode)
