...
import project.emarge.cropcarerep.viewModels.home.StockViewModel
import project.emarge.cropcarerep.views.adaptors.home.order.AddedProductsAdaptor
...
import project.emarge.cropcarerep.views.adaptors.home.order.ProductsAdaptor
import java.io.File
        ...
        pageViewModel.addStockProducts(qty, imagefilePath, addedProducts, pro, isImageFromCamera)
            .observe(this, Observer<ArrayList<Products>> {
                it?.let { result ->
                    ...
                    addedProductsAdaptor = AddedProductsAdaptor(result, context as Activity)
                    recyclerView_added_products_stock.adapter = addedProductsAdaptor
