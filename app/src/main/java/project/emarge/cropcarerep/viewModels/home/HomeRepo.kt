package project.emarge.cropcarerep.viewModels.home
...
import project.emarge.cropcarerep.models.datamodel.*
import project.emarge.cropcarerep.services.network.NetworkErrorHandler
...
class HomeRepo(application: Application) {
    ...
    var encryptedPreferences: EncryptedPreferences = EncryptedPreferences.Builder(application as Context?).withEncryptionPassword("122547895511").build()
    ...
    fun addPayments(
        ...
        when {
            (orderNumber == "").or((orderNumber.isNullOrEmpty())) -> Toast.makeText(app, "Please add order Number ", Toast.LENGTH_LONG).show()
            paymentType.isNullOrEmpty() -> Toast.makeText(app, "Please select Payment type ", Toast.LENGTH_LONG).show()
            (value == "0").and((orderNumber != vCode)) -> Toast.makeText(app, "Please add valid value", Toast.LENGTH_LONG).show()
            (value == "").or((value.isNullOrEmpty())) -> Toast.makeText(app, "Please add Value", Toast.LENGTH_LONG).show()
            (paymentType == "Cheque").and((selectedImagefilePath == Uri.EMPTY)) -> Toast.makeText(app, "Please add Image", Toast.LENGTH_LONG).show()
    ...
    fun savePayment(progressBar: ProgressBar, addedPayment: ArrayList<Payment>?, visitID: Int): MutableLiveData<Int> {
                ...
                .subscribe(object : Observer<Int> {
                    ...
                    override fun onNext(log: Int) {
                        ...
                        if (log != null) {
                            ...
                            Toast.makeText(app, "Payment Adding fail,Please try again ", Toast.LENGTH_LONG).show()
                        }
    ...
    fun saveStock(progressBar: ProgressBar, addedStock: ArrayList<Products>?, visitID: Int): MutableLiveData<Int> {
        ...
        if (!app.isConnectedToNetwork()) {
            ...
            println("vvvvvvvvvvv    saveStockVisitWithImageDetails : "+jsonObject)
                ...
                .subscribe(object : Observer<Int> {
                    ...
                    override fun onNext(log: Int) {
                        if (log != null) {
                            ...
                            Toast.makeText(app, "Stock Adding fail,Please try again ", Toast.LENGTH_LONG).show()
                        }
                    }
    ...
    fun addComplain(
        ...
        when {
            product.productsID == null -> Toast.makeText(app, "Please add product", Toast.LENGTH_LONG).show()
            dec.isNullOrEmpty() -> Toast.makeText(app, "Please add Description", Toast.LENGTH_LONG).show()
            invoiceNumber.isNullOrEmpty() -> Toast.makeText(app, "Please add Invoice Number", Toast.LENGTH_LONG).show()
            batchNum.isNullOrEmpty() -> Toast.makeText(app, "Please add Batch Number", Toast.LENGTH_LONG).show()
            else -> {
                var com = Complain()
                var filePath: String = ""
    ...
    fun saveComplain(
        ...
        if (!app.isConnectedToNetwork()) {
            ...
            println("vvvvvvvvvvv    saveComplainVisitWithImageDetails : "+jsonObject)
                ...
                .subscribe(object : Observer<Int> {
                    ...
                    override fun onNext(log: Int) {
                        if (log != null) {
                            ...
                            Toast.makeText(app, "Complain Adding fail,Please try again ", Toast.LENGTH_LONG).show()
                        }
                    }
